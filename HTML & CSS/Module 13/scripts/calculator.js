function equivalentCheck(){ //This allows the last value to remain in view until the new value is entered
...
function decimalPoint(){
    ...
    if(document.getElementById('decimalVar').value == 0){// This prevents muliple decimal points
